...
data = np.load('./training-scripts/data.npy')
labels = np.load('./training-scripts/label.npy')
...
model = myModel()
print(model.summary())
model.fit(X_train, Y_train, epochs=30, validation_data=(X_validate, Y_validate))
